...
function download_image($base64String){
    $data = $base64String;
    ...
    file_put_contents('/assets/img/tmp/test.png', $data);
}

if (isset($_GET['dl'])) {
//    download_image("data:image/png;base64,AAAFBfj42Pj4");
    echo "test hallo";
  }
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Gallerij</h4>
                                <p class="category">Alle foto's en video's</p>
                            </div>
                            <div class="content all-icons">
                                <div class="row">
                                  <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                      <div class="font-icon-detail"><img src="#" width="100px" height="100px" />
                                        <a href="?dl=test"><h5>Download</h5></a>
                                    </div>
                                  </div>
                                    <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                    <div class="font-icon-detail"><img src="#" width="100px" height="100px" />
                                        <a href="#"><h5>Download</h5></a>
                                    </div>
                                  </div>
